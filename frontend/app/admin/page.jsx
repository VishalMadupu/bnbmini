...
import { api, API, fileUrl } from "../../src/lib/api";
import { INDIAN_STATES, SOURCE_TYPES, VERIFICATION_OPTIONS, STATUS_OPTIONS, COLLAR_TYPES, AUTHORITY_TYPES, REQUIREMENT_TYPES, CONTENT_TYPES } from "../../src/lib/constants";
...
export default function Admin() {
  const [token, setToken] = useState(() => typeof window !== "undefined" ? localStorage.getItem("bnb_admin_token") : null);
