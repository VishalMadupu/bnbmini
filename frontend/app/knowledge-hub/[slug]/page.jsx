...
export default function KnowledgeDetail() {
  ...
  if (notFound) return <Layout><div className="mx-auto max-w-6xl px-4 py-24 text-center"><h1 className="font-display text-2xl font-bold text-brand-900">Article not found</h1><Link href="/knowledge-hub"><Button className="mt-6 bg-brand-600 text-white hover:bg-brand-700">Back to Knowledge Hub</Button></Link></div></Layout>;
  ...
  return (
    <Layout>
      ...
      <article className="mx-auto max-w-3xl px-4 py-8 sm:px-6 lg:px-8">
        <Link href="/knowledge-hub" className="inline-flex items-center gap-1 text-sm text-slate-500 hover:text-brand-600"><ArrowLeft className="h-4 w-4" /> Back to Knowledge Hub</Link>
