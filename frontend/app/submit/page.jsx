    ...
    <Layout>
      ...
      <div className="mx-auto max-w-4xl px-4 py-12 sm:px-6 lg:px-8">
        ...
        <div className="mt-8 grid grid-cols-1 gap-6 sm:grid-cols-2">
          {options.map((o) => (
            <Link key={o.to} href={o.to} data-testid={`submit-option-${o.to.split("/").pop()}`} className="group flex flex-col rounded-lg border border-slate-200 bg-white p-6 transition-transform transition-shadow hover:-translate-y-1 hover:shadow-md">
