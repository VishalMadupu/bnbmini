...
import { isMobile } from "../../../src/lib/validate";
...
export default function WorkRequirementDetail() {
  ...
  if (notFound) return <Layout><div className="mx-auto max-w-6xl px-4 py-24 text-center"><h1 className="font-display text-2xl font-bold text-brand-900">Requirement not found</h1><Link href="/work-requirements"><Button className="mt-6 bg-brand-600 text-white hover:bg-brand-700">Browse all requirements</Button></Link></div></Layout>;
  ...
  return (
    <Layout>
      ...
      <div className="mx-auto max-w-6xl px-4 py-6 sm:px-6 sm:py-8 lg:px-8">
        <Link href="/work-requirements" className="inline-flex items-center gap-1 text-sm text-slate-500 hover:text-brand-600"><ArrowLeft className="h-4 w-4" /> Back to Work Requirements</Link>
