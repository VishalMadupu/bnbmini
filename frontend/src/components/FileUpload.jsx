  ...
  return (
    <div>
      ...
      {value ? (
        ...
        <label
          data-testid={testid}
          className="flex cursor-pointer items-center justify-center gap-2 rounded-md border border-dashed border-slate-300 bg-white px-3 py-4 text-sm text-slate-500 hover:border-orange-400 hover:text-orange-600"
        >
